...
In order to edit the options you should move dataverse.default.properties file located in {Project Dir}/dataverse/dataverse-webapp/src/main/resources/config/dataverse.default.properties
