...
public class ExternalToolTest {
    ...
    public void testToJson() {
        ...
        ExternalTool externalTool = new ExternalTool(displayName, description, type, toolUrl, toolParameters, GeneralMimeType.TSV_ALT.getMimeType());
        ...
        assertEquals(GeneralMimeType.TSV_ALT.getMimeType(), jsonObject.getString(ExternalTool.CONTENT_TYPE));
    }
