...
public class ExternalToolHandlerTest {
    ...
    public void testGetToolUrlWithOptionalQueryParameters() {
        ...
        String result3 = externalToolHandler3.getQueryParametersForUrl("localhost:8080", "localhost:8080");
        ...
        String result4 = externalToolHandler4.getQueryParametersForUrl( "localhost:8080", "localhost:8080");
        ...
        try {
            ...
            String result5 = externalToolHandler5.getQueryParametersForUrl( "localhost:8080", "localhost:8080");
