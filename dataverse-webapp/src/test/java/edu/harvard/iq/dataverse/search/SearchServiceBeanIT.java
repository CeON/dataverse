...
public class SearchServiceBeanIT extends WebappArquillianDeployment {
    ...
    public void search__with_filters() throws SearchException {
        ...
        solrIndexCleaner.logTestEnd("search__with_filters");
    }
    ...
    public void search__with_dv_object_filter() throws SearchException {
        ...
        solrIndexCleaner.logTestEnd("search__with_dv_object_filter");
    }
    ...
    public void search__with_sorting() throws SearchException {
        ...
        assertSearchResultIds(searchService.search(adminDataverseRequest, dataverses, "*", SearchForTypes.all(), Collections.emptyList(), "dateSort", SortOrder.desc, 0, 20, false),
                "dataset_74", "dataset_73", "dataset_72", "dataset_57", "dataset_101", "dataset_102", "dataset_56_draft", "dataset_56", "dataset_66_draft",
                "dataset_71_draft",
        ...
        solrIndexCleaner.logTestEnd("search__with_sorting");
    }
    ...
    public void search__with_paging() throws SearchException {
        ...
        assertSearchResultIds(searchService.search(adminDataverseRequest, dataverses, "*", SearchForTypes.all(), Collections.emptyList(), "dateSort", SortOrder.desc, 0, 5, false),
                "dataset_74", "dataset_73", "dataset_72", "dataset_57", "dataset_101");
        ...
        solrIndexCleaner.logTestEnd("search__with_paging");
    }
    ...
    public void search__by_guest_user() throws SearchException {
        ...
        solrIndexCleaner.logTestEnd("search__by_guest_user");
    }
    ...
    public void search__query_all() throws SearchException {
        ...
        // then
        assertSearchResultIds(searchResponse, "dataset_74", "dataset_73", "dataset_72",
        ...
        assertContainsFacetCount(dvCategoryFacet, "Organization or Institution", 7);
        ...
        assertContainsFacetCount(publicationStatusFacet, "Published", 12);

        FacetCategory publicationDateFacet = extractFacetWithName(facets, "publicationDate");
        assertContainsFacetCount(publicationDateFacet, "2019", 9);
        ...
        solrIndexCleaner.logTestEnd("search__query_all");
    }
    ...
    public void search__no_results() throws SearchException {
        ...
        solrIndexCleaner.logTestEnd("search__no_results");
    }
