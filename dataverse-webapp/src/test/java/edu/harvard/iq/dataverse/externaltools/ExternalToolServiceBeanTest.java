...
public class ExternalToolServiceBeanTest {
    ...
    public void testfindAll() {
        ...
        ExternalTool externalTool = new ExternalTool("displayName", "description", type, "http://foo.com", "{}", TextMimeType.TSV_ALT.getMimeType());
    ...
    public void testParseAddExternalToolInput() {
        ...
        job.add("toolParameters", Json.createObjectBuilder()
                .add("queryParameters", Json.createArrayBuilder()
                        ...
                        .build())
                .build());
        job.add(ExternalTool.CONTENT_TYPE, TextMimeType.TSV_ALT.getMimeType());
    ...
    public void testParseAddExternalToolInputNoContentType() {
        ...
        assertEquals(externalTool.getContentType(), TextMimeType.TSV_ALT.getMimeType());
    }
