...
public class PasswordResetServiceBean {
    ...
    public PasswordChangeAttemptResponse attemptPasswordReset(BuiltinUser user, String newPassword, String token) {
        ...
        if (savedUser != null) {
            ...
            String messageBody = BundleUtil.getStringFromBundleWithLocale("notification.email.passwordResetConfirmation.subject", authUser.getNotificationsLanguage(), authUser.getName(), user.getUserName());
