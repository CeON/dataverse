...
public class DownloadedDatasetsChart implements Serializable {
    ...
    private static final String CHART_TYPE = "datasetsDownloaded";
    ...
    @Inject
    public DownloadedDatasetsChart(ChartCreator chartCreator, MetricsServiceBean metricsService, ChartTableCreator chartTableCreator) {
