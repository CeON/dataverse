...
public class RegisteredUsersChart implements Serializable {
    ...
    public void init() {
        ...
        usersChart = chartCreator.createYearlyChart(usersMetrics, CHART_TYPE, mode);
    }
    ...
    public void changeChartGrouping() {
        if (isYearlyChartSelected()) {
            ...
            usersChart = chartCreator.createMonthlyChart(usersMetrics, selectedYear, CHART_TYPE, mode);
        }
    }
