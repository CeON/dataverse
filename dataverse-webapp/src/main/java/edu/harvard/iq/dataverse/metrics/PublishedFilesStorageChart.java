...
public class PublishedFilesStorageChart implements Serializable {
    ...
    private final String CHART_TYPE = "filesStorage";
    ...
    @Inject
    public PublishedFilesStorageChart(ChartCreator chartCreator, MetricsServiceBean metricsService, ChartTableCreator chartTableCreator) {
